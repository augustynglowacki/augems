  ...
  return (
    <>
      <div className="container">
        <div className="pt-6 pb-4 mb-12 space-y-2 border-b lg:pt-0 2xl:pt-6 lg:pb-8 border-decoration-600 md:space-y-5">
          ...
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-decoration-900/70 pt-5 shadow-md shadow-gray-800/40 sm:flex">
            <div className="px-6 py-4">
              {pathname.startsWith('/blog') ? (
                ...
                <Link
                  href={`/blog`}
                  className="font-bold text-gray-200 uppercase hover:text-primary-500"
                >
                  All Posts
                </Link>
              )}
                  ...
                  return (
                    <li key={t} className="my-3">
                      {pathname.split('/tags/')[1] === slug(t) ? (
                        ...
                        <Link
                          href={`/tags/${slug(t)}`}
                          className="px-3 py-2 text-sm font-medium text-gray-200 uppercase hover:text-primary-500"
          ...
          <div>
            <ul>
              {displayPosts.map((post) => {
                ...
                return (
                  <li key={path} className="py-5 first:pt-0 last:pb-0">
